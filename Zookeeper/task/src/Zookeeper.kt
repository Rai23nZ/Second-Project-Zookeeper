...
fun main() {
    val greetingMessage = "Please enter the number of the habitat you would like to view:"
    println(greetingMessage)
    var inputData = readln()
    while (true) {
        if (inputData == "exit") {
            println("See you later!")
            break
        } else {
            val indexOfAnimals: Int = inputData.toInt()
            println(animals[indexOfAnimals])
            println(greetingMessage)
        }
        inputData = readln()
    }
